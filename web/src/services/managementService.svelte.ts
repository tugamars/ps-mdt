...
export function createManagementService() {
	...
	async function loadRoles() {
		...
		const seniorPerms = [...midPerms, "cases_create", "cases_edit", "evidence_create", "evidence_transfer", "reports_delete", "warrants_issue", "warrants_review", "warrants_approve", "cameras_view", "bodycams_view", "citizens_edit_licenses", "vehicles_edit_dmv"];
